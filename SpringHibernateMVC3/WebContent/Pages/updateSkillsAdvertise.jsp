...
<title>Create Advertise Skills</title>
...
<body>
	...
	<% int advertiseId = (int)request.getAttribute("advertiseId");%>
	<% session.setAttribute("advertiseId",(Integer)advertiseId); %>
	

    <a class="easyui-linkbutton" href="HomePage">برگشت به صفحه خانگی</a>
    <a class="easyui-linkbutton" href="HomePage">ارسال</a>	
    <div style="margin:20px 0;"></div>
	<div class="easyui-panel" title="صفحه بروز رسانی مهارت های موجود در آگهی" style="width:500;">
		<div style="padding:10px 60px 20px 60px">
	    <form:form id="ff" method="post" action="executeUpdateSkillsAdvertiseUpdate" modelAttribute="item">
	    	<h1>مشخصات مهارت</h1>
	    	<table cellpadding="5">
	    		<tr>
	...
	<div style="margin:20px 0;"></div>
	<div class="easyui-panel" title="صفحه افزودن به مهارت های موجود در آگهی" style="width:500;">
		<div style="padding:10px 60px 20px 60px">
			<form:form id="ff2" method="post" action="executeUpdateSkillsAdvertiseAdd" modelAttribute="additem">
	    	<h1>مشخصات مهارت</h1>
	    	<table cellpadding="5">
	    		<tr>
	    ...
	    <div style="margin:20px 0;"></div> 
	 <div style="margin:20px 0;"></div>
	<div class="easyui-panel" title="اطلاعات فعلی مهارت های آگهی" style="width:500;">
		<div style="padding:10px 60px 20px 60px">
		<table border="1">
            <tr>
                <th>شماره</th>
                ...
                <tr>
                    ...
                    <td>${item.name}</td>
                    <td><a href="editSkillsAdvertise?id=${item.id}">ویرایش</a></td>  
                   
    				<td><a href="deleteSkillsAdvertise?id=${item.id}">حذف</a></td>  
