...
<body>
	...
	<div class="easyui-panel" title="صفحه بروز رسانی مشخصات شرکت شما" style="width:500;">
		<div style="padding:10px 60px 20px 60px">
	    <form:form id="ff" method="post" action= "createCoDescription"  modelAttribute="company" >
	    	<h1>مشخصات شرکت</h1>
	    	<table cellpadding="5">
	    	    <tr>
                       <th>نام شرکت</th>   <td> <input class="easyui-textbox" data-options="required:true" name="name" value="${company.name}"></td>
                </tr>

                <tr>
                       <th>ایمیل شرکت</th>   <td> <input class="easyui-textbox" data-options="required:true" name="www" value="${company.www}"></td>
                </tr> 
                <tr>
                       <th>آدرس شرکت</th>   <td> <input class="easyui-textbox" data-options="required:true" name="address" value="${company.address}"></td>
                </tr>
            	<tr>
