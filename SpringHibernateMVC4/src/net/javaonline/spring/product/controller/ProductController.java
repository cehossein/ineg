 ...
 *  **************************************************************** */
		...
		///Work History
		  ...
		  //Individual 
			...
			@RequestMapping(value="/executeUpdateIndividualDescriptionUpdate",method = RequestMethod.POST)
			public ModelAndView executeUpdateWorkHistoryUpdate(@ModelAttribute("item") IndividualDescription item, HttpSession httpSession) {
			    ...
			    individualDescriptionService.update(item);
				List<IndividualDescription> individualDescriptions = individualDescriptionService.list();
			    model.addObject("item", new IndividualDescription());
			    model.addObject("itemList", individualDescriptions);
			    return model;
			}
			...
			public ModelAndView updateIndividualDescription(@ModelAttribute("user") User user, HttpSession httpSession) {
			    ...
			    IndividualDescription individualDescription = new IndividualDescription();
			    List<IndividualDescription> individualDescriptions = individualDescriptionService.list();
			    model.addObject("item", individualDescription);
			    model.addObject("itemList", individualDescriptions);
			  ...
			  @RequestMapping(value="/editIndividualDescription")
			    public ModelAndView editIndividualDescription(@RequestParam(value="id", required=true) int id 
			    		, HttpSession httpSession) {
			        ModelAndView model = new ModelAndView("updateIndividualDescription");
				    ...
				    model.addObject("type", type);
					  ...
					  List<IndividualDescription> individualDescriptions = individualDescriptionService.list();
					  IndividualDescription individualDescription = individualDescriptionService.getById(id);
				        model.addObject("item", individualDescription);
					    model.addObject("itemList", individualDescriptions);
